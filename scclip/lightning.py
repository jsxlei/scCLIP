...
class LitModule(pl.LightningModule):
    ...
    def fit(self, dataloader, device='cuda', max_epochs=None, max_steps=None, verbose=True):
        import tqdm
        import numpy as np
        self.to(device)
...
class LogGraphCallback(Callback):
    def on_train_start(self, trainer, pl_module):
        if pl_module.example_input_array is not None:
            pl_module.logger.experiment.add_graph(pl_module, pl_module.example_input_array)





def set_schedule(pl_module):  # https://github.com/dandelin/ViLT/blob/762fd3975c180db6fc88f577cf39549983fa373a/vilt/modules/vilt_utils.py
